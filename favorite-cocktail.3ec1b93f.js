 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();const Ol=nn({apiKey:"AIzaSyARB7IoC0JprBpfrU3Ehfw4t6yt6QUbzT0",authDomain:"cocktails-teamproject.firebaseapp.com",projectId:"cocktails-teamproject",storageBucket:"cocktails-teamproject.appspot.com",messagingSenderId:"738965521166",appId:"1:738965521166:web:18b2c801811c2fb026cd5f",databaseURL:"https://cocktails-teamproject-default-rtdb.europe-west1.firebasedatabase.app/"}),Al=function(e=sn(),t){const n=Zt(e,"database").getImmediate({identifier:t}),i=$e("database");if(i){const[e,t]=i.split(":");!function(e,t,n,i={}){(e=gt(e))._checkNotDeleted("useEmulator"),e._instanceStarted&&vr("Cannot call useEmulator() after instance has already been initialized.");const s=e._repoInternal;let r;if(s.repoInfo_.nodeAdmin)i.mockUserToken&&vr('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new Dr(Dr.OWNER);else if(i.mockUserToken){const t="string"==typeof i.mockUserToken?i.mockUserToken:Be(i.mockUserToken,e.app.options.projectId);r=new Dr(t)}!function(e,t,n,i){e.repoInfo_=new xr(`${t}:${n}`,!1,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams),i&&(e.authTokenProvider_=i)}(s,t,n,r)}(n,e,parseInt(t,10))}return n}(Ol),Dl=function(e=sn()){const t=Zt(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=Zt(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(rt(n.getOptions(),null!=t?t:{}))return e;bn(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Qs,persistence:[ps,Zi,ts]}),i=ze("authTokenSyncURL");if(i){const e=(s=i,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>Zs)return;const i=null==t?void 0:t.token;er!==i&&(er=i,await fetch(s,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))});!function(e,t,n){gt(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,i){gt(e).onIdTokenChanged(t,n,i)}(n,(t=>e(t)))}var s;const r=$e("auth");return r&&Ii(n,`http://${r}`),n}(Ol),Ml=document.querySelector(".auth-btn"),xl=document.querySelector("#registration-form"),Fl=document.querySelector(".registration-btn"),Ul=document.querySelector(".signin-btn"),ql=document.querySelector(".logout-btn"),jl=document.querySelector(".reg-form-title"),Wl=document.querySelector(".cocktails__list"),Hl=document.querySelector(".not-found"),$l=document.querySelector(".cocktails__title");Fl.addEventListener("click",(function(e){e.preventDefault();const t=xl.elements.email.value,n=xl.elements.password.value;Ji(Dl,t,n).then((e=>{console.log(e),console.log("registration successful");e.user})).catch((e=>{const t=e.code,n=e.message;console.log(t,n)}))})),Ul.addEventListener("click",(function(e){e.preventDefault();const t=xl.elements.email.value,n=xl.elements.password.value;Yi(Dl,t,n).then((e=>{e.user;console.log("success sign in")})).catch((e=>{e.code;const t=e.message;console.log(t)}))})),ql.addEventListener("click",(function(e){(t=Dl,gt(t).signOut()).then((()=>{console.log("sign out successful")})).catch((e=>{}));var t}));let zl="";var Vl,Bl,Kl;Vl=e=>{e?(zl=e.uid,console.log("sign changed",zl),jl.textContent="Success! ✔",jl.classList.add("success-auth"),document.querySelector(".reg-form").style.display="none",setTimeout((()=>{document.querySelector(".back-drop-reg").classList.add("is-hide"),jl.textContent="Please log in or create new account",jl.classList.remove("success-auth"),document.querySelector(".reg-form").style.display="block"}),1e3),Ml.style.backgroundColor="#f3f503"):(console.log("signed out"),jl.textContent="Success! ✔",jl.classList.add("success-auth"),document.querySelector(".reg-form").style.display="none",setTimeout((()=>{document.querySelector(".back-drop-reg").classList.add("is-hide"),jl.textContent="Please log in or create new account",jl.classList.remove("success-auth"),document.querySelector(".reg-form").style.display="block"}),1e3),Ml.style.backgroundColor="transparent",zl="")},gt(Dl).onAuthStateChanged(Vl,Bl,Kl);const Gl=document.querySelector(".cocktails.section"),Jl=document.querySelector(".js-fav-cocktail"),Yl=document.querySelector(".js-fav-ingr"),Ql=document.querySelector(".modal__ingredients");function Xl(e){e.target.classList.contains("btn-add-fav")&&zl&&Sl(Cl(Al,"favoriteIngr/"+zl),{savedIngr:I("ingridients")})}Gl.addEventListener("click",(function(e){e.target.classList.contains("btn-add")&&zl&&(t=zl,Sl(Cl(Al,"favorite/"+t),{savedDrinks:I("cocktails")}));var t})),Ql.addEventListener("click",Xl),Wl.addEventListener("click",Xl),Jl.addEventListener("click",(e=>{var t;e.preventDefault(),(t=zl,fetch(`https://cocktails-teamproject-default-rtdb.europe-west1.firebasedatabase.app/favorite/${t}.json`).then((e=>e.json().then((e=>Object.values(e)))))).then((async e=>{let t=[];Hl.classList.add("is-hidden"),$l.classList.remove("is-hidden");const n=e[0].map((async e=>await r(e)));(await Promise.all(n)).map((({drinks:e})=>{t.push(e[0])})),console.log(t),document.querySelector(".hero").style.display="none",$l.innerHTML="Favorite cocktails",Wl.innerHTML=c(t);document.querySelectorAll(".btn-add").forEach((e=>{e.textContent="Remove"}))})).catch((e=>{console.log(e),Wl.innerHTML="",Hl.classList.remove("is-hidden"),$l.classList.add("is-hidden")}))})),Yl.addEventListener("click",(e=>{var t;e.preventDefault(),Hl.classList.add("is-hidden"),$l.classList.remove("is-hidden"),(t=zl,fetch(`https://cocktails-teamproject-default-rtdb.europe-west1.firebasedatabase.app/favoriteIngr/${t}.json`).then((e=>e.json().then((e=>Object.values(e)))))).then((async e=>{let t=[];const n=e[0].map((async e=>await a(e)));(await Promise.all(n)).map((({ingredients:e})=>{t.push(e[0])})),document.querySelector(".hero").style.display="none",$l.innerHTML="Favorite ingredients",Wl.innerHTML=t.map((({idIngredient:e,strType:t,strIngredient:n})=>`<li class="ingredients__card">\n              <h3 class="ingredients__title">${n}</h3>\n              <p class="ingredients__text">${t}</p>\n              <div class="button-wrapper" data-ingr="${e}">\n                <button class="btn-lm" type="button">Learn more</button>\n                <button class="btn-add-fav" type="button">Add to favorite</button>\n              </div>\n            </li>`)).join("");document.querySelectorAll(".btn-add-fav").forEach((e=>{e.textContent="Remove"}))})).catch((e=>{console.log(e),Wl.innerHTML="",Hl.classList.remove("is-hidden"),$l.classList.add("is-hidden")}))})),Ml.addEventListener("click",(function(){document.querySelector(".back-drop-reg").classList.remove("is-hide")})),document.querySelector(".reg-close-btn").addEventListener("click",(()=>{document.querySelector(".back-drop-reg").classList.add("is-hide")}));
//# sourceMappingURL=favorite-cocktail.3ec1b93f.js.map
